 ...
 */
class GlyphIconExtension extends Twig_Extension
{
	...
	{
		return array(
			new Twig_SimpleFunction('glyphIco', array($this, 'iconFunction'), array('pre_escape' => 'html', 'is_safe' => array('html'))));
	}
	...
	{
		$that = $this;
		return preg_replace_callback('/\.glyphIco-([a-z0-9-]+)/', 
	...
	{
		return 'Sasedev.Commons.Twig.GlyphIcon';
	}
}
