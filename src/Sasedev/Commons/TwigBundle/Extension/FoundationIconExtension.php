...
/**
 * Foundation icon helper
 * 
 * @author sasedev <seif.salah@gmail.com>
 */
class FoundationIconExtension extends Twig_Extension
{
	...
	{
		return array(
			new Twig_SimpleFunction('fiIco', array($this, 'iconFunction'), array('pre_escape' => 'html', 'is_safe' => array('html'))));
	}
	...
	{
		$that = $this;
		return preg_replace_callback('/\.fiIco-([a-z0-9-]+)/', 
	...
	{
		return sprintf('<span class="fi-%s"></span>', $icon);
	}
	...
	{
		return 'Sasedev.Commons.Twig.FoundationIcon';
	}
}
